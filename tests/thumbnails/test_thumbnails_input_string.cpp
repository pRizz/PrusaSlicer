...
static std::string empty_thumbnails() { return ""; }

static std::string valid_thumbnails() { return "160x120/PNG, 23x78/QOI, 230x780/JPG"; }
...
static std::string invalid_val_thumbnail3() { return "x/PNg, 23x78/QOI, 320x240/PNG, 230x780/JPG"; }

static std::string invalid_val_thumbnail4() { return "23*78/QOI, 320x240/PNG, 230x780/JPG"; }
